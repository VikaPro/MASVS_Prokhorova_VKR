/****************************************************************************
** Meta object code from reading C++ file 'projectsmodel.h'
**
...
#error "The header file 'projectsmodel.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ProjectsModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ProjectsModel_t qt_meta_stringdata_ProjectsModel = {
    {
QT_MOC_LITERAL(0, 0, 13), // "ProjectsModel"
QT_MOC_LITERAL(1, 14, 6), // "clearR"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "ProjectsModel\0clearR\0"
};
...
QT_INIT_METAOBJECT const QMetaObject ProjectsModel::staticMetaObject = { {
    &QAbstractListModel::staticMetaObject,
    qt_meta_stringdata_ProjectsModel.data,
